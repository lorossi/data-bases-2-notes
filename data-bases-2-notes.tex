...
\begin{table}[htbp]
  ...
  \begin{tblr}{colspec={r|c|c}, row{1}={font=\itshape}, column{1}={font=\itshape}}
    ...
    & \hline
    access path defined & \colorxmark & \colorcmark \\
    constraint defined & \colorcmark       & \colorxmark \\
    unique & \colorcmark                     & \colorxmark \\
    implementation by index& \colorcmark    & \colorxmark                            \\
  \end{tblr}
